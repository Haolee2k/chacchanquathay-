...
{
	if($loaiDB->them($_POST['txtMaLoai'],$_POST['txtTenLoai'],$_POST['txthinh'])>0)
...
<div class="select-bar">
        ...
        <table class="listing form" cellpadding="0" cellspacing="0" width="400">
          ...
          <tr class="bg">
            <td class="first" width="172"><strong>Hình loại</strong></td>
            <td class="last"><input type="text" class="text" name="txthinh" id="txthinh" value="<?php if(isset($loaisua[0]['maloai'])) echo $loaisua[0]['hinhloai']; ?>" /></td>
          </tr>
          <tr>
