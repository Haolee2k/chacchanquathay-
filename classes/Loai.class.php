...
class Loai extends Db{
	...
	public function them($ma,$ten,$hinh)
	{
		$sql="insert into loai value(?,?,?)";
		return $this->exeNoneQuery($sql,array($ma,$ten,$hinh));
	}
	...
	{
		//Kiem tra co dienthoai nao trong loai do ko?
		$sql="select count(*) as dem from dienthoai where maloai=?";
